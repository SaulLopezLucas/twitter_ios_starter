...
//  Twitter
//
//  Created by Saul Lopez Lucas on 10/1/22.
...
class TweetCellTableViewCell: UITableViewCell {
    ...
    @IBAction func favoriteTweet(_ sender: Any) {
        ...
        }else{ TwitterAPICaller.client?.unfavoriteTweet(tweetId: tweetId, success: {self.setFavorite(false)}, failure: {(error) in print("Unfavorite did not succeed: \(error)")})
